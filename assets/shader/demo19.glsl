...
void buildScene(inout World world){
    ...
    worldAddSphere(world , Sphere(vec3(-1.0, 0.0, -2.0) , 
        0.5  ,Material(MATERIAL_TYPE_DIELECTRIC , vec3(0.8, 0.8, 0.8) , 1.5)));

    //middle
    worldAddSphere(world , Sphere(vec3(0.0, 0.2 + uDeltaY, -2.0) , 
        0.5 ,Material(MATERIAL_TYPE_LAMBERTIAN , vec3(0.1, 0.2, 0.5) , 0.0)));
    // worldAddSphere(world , Sphere(vec3(0.0, 0.2 + uDeltaY, -2.0) , 
    //     0.5 ,Material(MATERIAL_TYPE_DIELECTRIC , vec3(0.1, 0.2, 0.5) , 1.5)));

    //right
    worldAddSphere(world , Sphere(vec3(1.0, 0.0, -2.0) , 
        0.5  ,Material(MATERIAL_TYPE_METAL , vec3(0.8, 0.6, 0.2) , 0.0)));
